...
#
# Always on — gobo only exists to be poked at. UI buttons that hit these
# endpoints live on the /symdb page. bin/symdb-hot-load-test is the
# scripted orchestrator that exercises the same endpoints headlessly.
